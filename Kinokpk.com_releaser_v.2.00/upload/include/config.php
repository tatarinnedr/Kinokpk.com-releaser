...
$SITENAME = "Kinokpk.com releaser 2.00"; // Your site title

$DESCRIPTION = "Kinokpk.com releaser 2.00 - Ultimate Filesharing x2!"; // Meta description
$KEYWORDS = "kinokpk, kinokpk.com, releaser, 2.00, ZonD80"; // Meta keywords, separate by commas

$autoclean_interval = 900; // autoclean interval (cleanup.php)
$pic_base_url = "./pic/"; // Image folder

define("YOURCOPY","&copy; Kinokpk.com releaser 2.00 new installation"); // Your custom copyright (will be in footer)
...
$FORUMURL = "http://forum.com"; // Fourm URL (e.g. http://www.forum.ru, WITHOUT / )
$FORUMNAME = "Kinokpk.com releaser integrated forum"; // Name of your forum
