...
elseif (($_GET['action'] == 'add') && ($_GET['class'] == 'type')) {
  ...
  print("<table width=\"100%\"><form action=\"?class=type&action=saveadd\" enctype=\"multipart/form-data\" name=\"savearray\" method=\"post\"><tr><td class=\"colhead\">Название типа контента</td></tr><tr><td><input type=\"text\" name=\"type\" size=\"80\"></td></tr><tr><td class=\"colhead\">Является категорией <input type=\"text\" name=\"category\"></td></tr></table>
...
elseif (($_GET['action'] == 'edit') && ($_GET['class'] == 'type')) {
  ...
  print("<table width=\"100%\"><form name=\"save\" enctype=\"multipart/form-data\" action=\"?class=type&action=saveedit\" method=\"post\"><tr><td class=\"colhead\">Название типа контента</td></tr><tr><td><input type=\"text\" name=\"type\" size=\"80\" value=\"$type\"></td></tr><tr><td class=\"colhead\">Является категорией <input type=\"text\" name=\"category\" value=\"$category\"></table>
